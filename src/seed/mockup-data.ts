        ...
        f: [
          ...
          },
          {
            ...
            e: [
              ...
              { n: 'idp-role-matrix.png', ty: 'PNG', d: '2026-07-07', ex: '', by: 'Dhiaz Fathra' },
            ],
          },
          {
        ...
        f: [
          {
            ...
            e: [
              ...
              { n: 'backup-job-log.png', ty: 'PNG', d: '2026-08-25', ex: '', by: 'Dhiaz Fathra' },
            ],
          },
        ],
      },
...
export const VERS: Record<string, MockRevision[]> = {
  ...
  'patch-tracker.xlsx': [
    ...
    { v: 'v2', d: '2026-07-18', by: 'Dhiaz Fathra', note: 'SLA columns split by severity.' },
    { v: 'v1', d: '2026-06-20', by: 'Dhiaz Fathra', note: 'Template issued.' },
  ],
}
